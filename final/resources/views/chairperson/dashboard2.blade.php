...
@section('content')
    ...
    <div class="main-content">
        ...
        <!-- Top Navigation -->
        <nav class="top-navbar navbar navbar-expand-lg navbar-light bg-white shadow-sm py-1 px-2 mb-2 sticky-top">
            <div class="container-fluid d-flex justify-content-between align-items-center p-0">
                <div class="d-flex align-items-center">
                    <button class="sidebar-collapse-btn btn btn-link text-dark p-0 me-1 d-lg-none"
                        id="sidebarToggle">
                        <i class="fas fa-bars fs-4"></i>
                    </button>
                    <span class="navbar-brand fw-bold text-primary ms-1" id="adminGreeting">Good </span>
                </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center ms-1">
                                ...
                                <div class="notification-list" style="max-height: 300px; overflow-y: auto;">
                                    <a href="#" class="dropdown-item d-flex py-2 px-2 notification-item unread">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="bg-primary bg-opacity-10 p-1 rounded-circle d-flex align-items-center justify-content-center"
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-start mb-1">
                                                <h6 class="mb-0 fw-semibold">New User</h6>
                                                <small class="text-muted">2 min ago</small>
                                            </div>
                                            <p class="mb-0 text-muted small">John Doe registered</p>
                                        </div>
                                    </a>
                                    <a href="#" class="dropdown-item d-flex py-2 px-2 notification-item unread">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="bg-warning bg-opacity-10 p-1 rounded-circle d-flex align-items-center justify-content-center"
                                                style="width: 30px; height: 30px;">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-start mb-1">
                                                <h6 class="mb-0 fw-semibold">Server Alert</h6>
                                                <small class="text-muted">1 hour ago</small>
                                            </div>
                                            <p class="mb-0 text-muted small">High CPU usage detected</p>
                                        </div>
                                    </a>
                                    <a href="#" class="dropdown-item d-flex py-2 px-2 notification-item">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="bg-success bg-opacity-10 p-1 rounded-circle d-flex align-items-center justify-content-center"
                                                style="width: 30px; height: 30px;">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-start mb-1">
                                                <h6 class="mb-0 fw-semibold">Task Complete</h6>
                                                <small class="text-muted">3 hours ago</small>
                                            </div>
                                            <p class="mb-0 text-muted small">Backup completed</p>
                                        </div>
                                    </a>
                        ...
                        <div class="d-flex align-items-center ms-1 border-start ps-2">
                            ...
                            <div class="d-none d-md-inline">
                                <div class="fw-bold text-dark" style="font-size: 0.8rem;">John Doe</div>
                                <div class="small text-muted" style="font-size: 0.7rem;">Admin</div>
                            </div>
                        </div>
                    </div>
                </div>
