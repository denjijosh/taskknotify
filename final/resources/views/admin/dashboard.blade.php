    ...
    <style>
        ...
        .credential-activity:nth-child(1) { animation-delay: 0.3s; }
        .credential-activity:nth-child(2) { animation-delay: 0.4s; }
        .credential-activity:nth-child(3) { animation-delay: 0.5s; }
    ...
    <div class="main-content">
        ...
        <!-- Top Navigation -->
        <nav class="navbar navbar-expand-lg navbar-light bg-white rounded top-navbar">
            <div class="container-fluid">
                <button class="sidebar-collapse-btn btn btn-link text-dark p-0 me-2 d-lg-none" id="sidebarToggle">
                    <i class="fas fa-bars"></i>
                </button>
                <span class="navbar-brand fw-bold text-primary" id="adminGreeting">Good Morning</span>
                ...
                <div class="d-flex align-items-center ms-auto">
                    ...
                    <div class="dropdown position-relative me-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-end notification-dropdown p-0" 
                            aria-labelledby="notificationDropdown" style="width: 280px;">
                            <div class="d-flex justify-content-between align-items-center p-2 border-bottom bg-light">
                                <h6 class="m-0 fw-bold" style="font-size: 0.875rem;">Notifications</h6>
                                <div>
                                    <span class="badge bg-primary rounded-pill me-1" style="font-size: 0.625rem;">3</span>
                                    <button class="btn btn-sm btn-link text-muted p-0" title="Mark all as read" style="font-size: 0.75rem;">
                            ...
                            <div class="notification-list" style="max-height: 300px; overflow-y: auto;">
                                <a href="#" class="dropdown-item d-flex py-2 px-2 notification-item unread">
                                    <div class="flex-shrink-0 me-2">
                                        <div class="bg-primary bg-opacity-10 p-1 rounded-circle" style="width: 30px; height: 30px;">
                                            <i class="fas fa-user-check text-primary" style="font-size: 0.875rem;"></i>
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start mb-1">
                                            <h6 class="mb-0 fw-semibold" style="font-size: 0.8125rem;">New User Registered</h6>
                                            <small class="text-muted" style="font-size: 0.6875rem;">2 min ago</small>
                                        </div>
                                        <p class="mb-0 text-muted" style="font-size: 0.75rem;">John Doe has registered as a new user.</p>
                                    </div>
                                </a>
                    ...
                    <div class="dropdown">
                        ...
                        id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{ Auth::user()->avatar_url ?? asset('storage/profile/avatars/profile.png') }}"
                                alt="User Profile" class="rounded-circle me-1" width="32" height="32">
                            <span class="d-none d-md-inline fw-bold text-dark" style="font-size: 0.875rem;">
                                {{ explode(' ', ucwords(strtolower(Auth::user()->name)))[0] }}
                            </span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown" style="font-size: 0.8125rem;">
    ...
    <div class="dashboard-card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5><i class="fas fa-chart-line me-1"></i>Document Metrics</h5>
    ...
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <polyline points="6 9 12 15 18 9"></polyline>
            ...
            <div class="row g-1 mx-1 mb-2 mt-1">
                <div class="col-md-6">
                    <select class="filter-control w-100" id="metricsDepartmentFilter" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">
                ...
                <div class="col-md-6">
                    <select class="filter-control w-100" id="metricsStatusFilter" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">
            ...
            <div class="chart-container position-relative" style="height: 250px; margin: 0 0.5rem;">
                ...
                <!-- Hover Tooltip -->
                <div class="chart-hover-tooltip" style="display: none; position: absolute; background: rgba(30, 41, 59, 0.95); color: white; padding: 0.5rem 0.75rem; border-radius: 0.25rem; font-size: 0.75rem; pointer-events: none; z-index: 10; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
      ...
      <polyline points="6 9 12 15 18 9"></polyline>
            ...
            <div class="card-body" style="overflow-y: auto; max-height: 300px; padding: 0.5rem;">
                ...
                <div class="top-performer" data-department="marketing">
                    ...
                    <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Sarah Johnson" class="performer-avatar">
                    <div class="performer-details" style="flex: 1; min-width: 0;">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 style="font-size: 0.875rem; font-weight: 600; margin-bottom: 0.1rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Elisha Fernanzez</h6>
                            <span class="performance-percentage" style="color: #3b82f6; font-size: 0.75rem; font-weight: bold;">98%</span>
                        </div>
                        <div class="performer-department" style="font-size: 0.7rem; color: #64748b; margin-bottom: 0.2rem;">IT Department</div>
                ...
                <div class="top-performer" data-department="development">
                    ...
                    <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Michael Chen" class="performer-avatar">
                    <div class="performer-details" style="flex: 1; min-width: 0;">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 style="font-size: 0.875rem; font-weight: 600; margin-bottom: 0.1rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Joshua Daroya</h6>
                            <span class="performance-percentage" style="color: #3b82f6; font-size: 0.75rem; font-weight: bold;">95%</span>
                        </div>
                        <div class="performer-department" style="font-size: 0.7rem; color: #64748b; margin-bottom: 0.2rem;">Office Admin</div>
                ...
                <div class="top-performer" data-department="design">
                    ...
                    <img src="https://randomuser.me/api/portraits/women/68.jpg" alt="Emily Rodriguez" class="performer-avatar">
                    <div class="performer-details" style="flex: 1; min-width: 0;">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 style="font-size: 0.875rem; font-weight: 600; margin-bottom: 0.1rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Jommel Incipido</h6>
                            <span class="performance-percentage" style="color: #3b82f6; font-size: 0.75rem; font-weight: bold;">92%</span>
                        </div>
                        <div class="performer-department" style="font-size: 0.7rem; color: #64748b; margin-bottom: 0.2rem;">Backend Developer</div>
                ...
                <div class="text-center mt-1">
                    <a href="#" class="text-primary" style="font-size: 0.75rem;">View Full Leaderboard <i class="fas fa-chevron-right" style="font-size: 0.6rem;"></i></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row g-2">
                    <div class="col-6">
                        <div class="d-flex align-items-center mb-2">
                            <div class="legend-color me-2" style="background-color: #10b981; width: 12px; height: 12px; border-radius: 3px;"></div>
                            <div class="flex-grow-1">
                                ...
                                <div class="progress mt-1" style="height: 4px;">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: 69.4%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="d-flex align-items-center mb-2">
                            <div class="legend-color me-2" style="background-color: #3b82f6; width: 12px; height: 12px; border-radius: 3px;"></div>
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress mt-1" style="height: 4px;">
                                    <div class="progress-bar bg-primary" role="progressbar" style="width: 11.5%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="d-flex align-items-center mb-2">
                            <div class="legend-color me-2" style="background-color: #64748b; width: 12px; height: 12px; border-radius: 3px;"></div>
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress mt-1" style="height: 4px;">
                                    <div class="progress-bar bg-secondary" role="progressbar" style="width: 15.9%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="d-flex align-items-center mb-2">
                            <div class="legend-color me-2" style="background-color: #ef4444; width: 12px; height: 12px; border-radius: 3px;"></div>
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress mt-1" style="height: 4px;">
                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 3.2%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="col-lg-6">
    <div class="dashboard-card h-100">
        <div class="card-header d-flex justify-content-between align-items-center border-bottom pb-2" style="color: #fff; background: linear-gradient(135deg, var(--primary) 0%, var(--primary-dark) 100%);">
        ...
        <div class="card-body p-0" style="overflow-y: auto; max-height: 300px;">
            ...
            <div class="list-group list-group-flush">
                ...
                <div class="list-group-item border-0 py-3 px-4" data-department="marketing">
                    <div class="d-flex align-items-start">
                        <div class="flex-shrink-0">
                            <div class="bg-primary bg-opacity-10 p-2 rounded-circle d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge bg-success bg-opacity-10 text-success fs-11 fw-medium px-2 py-1">Approved</span>
                ...
                <div class="list-group-item border-0 py-3 px-4" data-department="development">
                    <div class="d-flex align-items-start">
                        <div class="flex-shrink-0">
                            <div class="bg-secondary bg-opacity-10 p-2 rounded-circle d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;">
                ...
                <div class="list-group-item border-0 py-3 px-4" data-department="design">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="badge bg-warning bg-opacity-10 text-warning fs-11 fw-medium px-2 py-1">In Review</span>
                ...
                <div class="col-lg-8">
                    <div class="dashboard-card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('tasks.index') }}" class="btn btn-sm btn-primary" style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">
                                View All
                            </a>
                        </div>
                        <div class="card-body">
